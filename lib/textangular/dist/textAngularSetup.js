...
angular.module('textAngularSetup', ['ngAnimate', 'ui.bootstrap'])
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log', '$uibModal','$templateCache',
function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, $log, $uibModal, $templateCache) {
        ...
        taRegisterTool('insertTable', {
            ...
            action: function (deferred) {
                ...
                $uibModal.open({
                    ...
                    template: $templateCache.get('/pages/textAngularTools/insertTable/insert-table.html')
